...
static bool PCM5242_WriteRegister(pcm5242_handle_t pcm5242, uint16_t reg, uint8_t value)
{
...
static bool PCM5242_ReadRegister(pcm5242_handle_t pcm5242, uint16_t reg, uint8_t *value)
{
	const uint8_t page = PCM5242_GET_PAGE(reg);
	const uint8_t addr = PCM5242_GET_ADDR(reg);
